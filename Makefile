...
#RASCAL_AUTOGENERATED_FILE = $(obj)include/rascal_autogenerated.h
...
.PHONY : $(LIBS) $(TIMESTAMP_FILE) $(VERSION_FILE) $(RASCAL_AUTOGENERATED_FILE)
...
#$(RASCAL_AUTOGENERATED_FILE):

rascal_autogenerated.h:	
		$(MAKE) -C include
...
rascal_config   :   $(RASCAL_AUTOGENERATED_FILE)  unconfig
	@mkdir -p $(obj)include
	$(MAKE) -C $(obj)include
...
clean:
	...
	@rm -f $(TIMESTAMP_FILE) $(VERSION_FILE) $(RASCAL_AUTOGENERATED_FILE)
	@find $(OBJTREE) -type f \
